    ...
    return (
        <div className="container">
            ...
            <div className="info__items-container">
                <div><a href="/info/sobre-nosotros" title="Sobre nosotros"><i className="fa-solid fa-plus"></i>Sobre nosotros</a></div>
                <div><a href="/info/como-comprar" title="Cómo comprar"><i className="fa-solid fa-plus"></i>Cómo comprar</a></div>
                <div><a href="/info/medios-de-pago" title="Medios de pago"><i className="fa-solid fa-plus"></i>Medios de pago</a></div>
                <div><a href="/info/sobre-envios" title="Métodos de envío"><i className="fa-solid fa-plus"></i>Métodos de envío</a></div>
                <div><a href="#" title="Seguimiento de compra"><i className="fa-solid fa-plus"></i>Seguimiento de compra</a></div>
                <div><a href="/info/despues-de-comprar" title="Después de comprar"><i className="fa-solid fa-plus"></i>Después de comprar</a></div>
                <div><a href="/contacto" title="Contacto"><i className="fa-solid fa-plus"></i>Contacto</a></div>
            </div>
